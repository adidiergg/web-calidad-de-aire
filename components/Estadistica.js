...
export default function Estadistica() {
    ...
    async function getDataCentro() {
      try {
        const response = await fetch('http://127.0.0.1:8000/estadistica/centro', {
          method: 'GET',
          headers: {
            accept: 'application/json',
  ...
  async function getDataNoreste() {
    try {
      const response = await fetch('http://127.0.0.1:8000/estadistica/noreste', {
        method: 'GET',
        headers: {
          accept: 'application/json',
...
async function getDataNoroeste() {
  try {
    const response = await fetch('http://127.0.0.1:8000/estadistica/noroeste', {
      method: 'GET',
      headers: {
        accept: 'application/json',
...
async function getDataSureste() {
  try {
    const response = await fetch('http://127.0.0.1:8000/estadistica/sureste', {
      method: 'GET',
      headers: {
        accept: 'application/json',
...
async function getDataSuroeste() {
  try {
    const response = await fetch('http://127.0.0.1:8000/estadistica/suroeste', {
      method: 'GET',
      headers: {
        accept: 'application/json',
...
async function getStatus() {
  try {
    ...
    return isClean===true ? (
      ...
      <a href="limpieza" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Proceso estadistico vacio, ir a proceso de limpieza</a>
